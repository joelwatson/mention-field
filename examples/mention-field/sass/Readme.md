...
folder are mapped to the application's root namespace, 'MentionExample'. This is set in
`"app.json"`:

    "sass": {
        "namespace": "MentionExample"
    }
...
included in the application's JavaScript code build. By default, files in this 
folder are mapped to the application's root namespace, 'MentionExample' in the same way
as `"MentionExample/sass/src"`.
